...
Source0  : https://files.pythonhosted.org/packages/a3/f8/a91baa48ef5097d89cf4c7381b76657931fe525fad4d912bd6ac62386ac6/azure-mgmt-batch-9.0.0.zip
Summary  : Microsoft Azure Batch Management Client Library for Python
Group    : Development/Tools
License  : MIT
Requires: azure-mgmt-batch-python = %{version}-%{release}
Requires: azure-mgmt-batch-python3 = %{version}-%{release}
...
%package python
Summary: python components for the azure-mgmt-batch package.
Group: Default
Requires: azure-mgmt-batch-python3 = %{version}-%{release}

%description python
python components for the azure-mgmt-batch package.


%package python3
Summary: python3 components for the azure-mgmt-batch package.
Group: Default
Requires: python3-core
Provides: pypi(azure_mgmt_batch)
Requires: pypi(azure_common)
Requires: pypi(msrest)
Requires: pypi(msrestazure)

%description python3
python3 components for the azure-mgmt-batch package.


%prep
%setup -q -n azure-mgmt-batch-9.0.0
cd %{_builddir}/azure-mgmt-batch-9.0.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1608045581
